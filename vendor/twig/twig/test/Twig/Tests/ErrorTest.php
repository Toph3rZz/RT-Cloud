...
class Twig_Tests_ErrorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testTwigExceptionAddsFileAndLineWhenMissingWithInheritanceOnDisk()
    {
        ...
        try {
            ...
            $this->assertEquals('Variable "foo" does not exist in "create.html" at line 3', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('create.html', $e->getTemplateFile());
        }
        ...
        try {
            ...
            $this->assertEquals('An exception has been thrown during the rendering of a template ("Runtime error...") in "create.html" at line 3.', $e->getMessage());
            $this->assertEquals(3, $e->getTemplateLine());
            $this->assertEquals('create.html', $e->getTemplateFile());
        }
    }
