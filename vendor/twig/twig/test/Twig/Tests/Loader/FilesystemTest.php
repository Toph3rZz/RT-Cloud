...
class Twig_Tests_Loader_FilesystemTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testPaths()
    {
        ...
        $this->assertEquals("path (final)\n", $loader->getSource('create.html'));
        $this->assertEquals("path (final)\n", $loader->getSource('@__main__/create.html'));
        $this->assertEquals("named path (final)\n", $loader->getSource('@named/create.html'));
    }
    ...
    public function testFindTemplateWithCache()
    {
        ...
        // prime the cache for create.html in the named namespace
        $namedSource = $loader->getSource('@named/create.html');
        $this->assertEquals("named path\n", $namedSource);

        // get create.html from the main namespace
